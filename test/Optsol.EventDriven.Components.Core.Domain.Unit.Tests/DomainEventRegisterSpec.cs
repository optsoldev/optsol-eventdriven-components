...
namespace Optsol.EventDriven.Components.Core.Domain.Unit.Tests
{
    ...
    public record EventoTeste(Guid TransactionId, Guid ModelId, int ModelVersion, DateTime When): IDomainEvent { }
    public record EventoTeste2(Guid TransactionId, Guid ModelId, int ModelVersion, DateTime When, DateTime AnotherProperty) : IDomainEvent { }
}
